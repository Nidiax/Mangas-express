...
namespace MangaExpressController.Pages.PagesUsuario
{
   [AllowAnonymous]
    public class CarritoModel : PageModel
    {
        ...
        public CarritoModel(/*ILogger<IndexModel> logger,*/ ApplicationDbContext _context)
        {
            // _logger = logger;
...

        {
            ...
            //Debo obtener el usuario logueado 
            //Mangas = await mangaContext.MangaUsuarios.Where(x => x.UID == IdUsuario).ToListAsync();
