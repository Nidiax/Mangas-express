...
namespace MangaExpressController.Areas.Identity.Pages.CrudManga1
{
    [AllowAnonymous]
    public class DetailsMangaModel : PageModel
    {
        private readonly MangaExpressController.Data.ApplicationDbContext _context;

        public DetailsMangaModel(MangaExpressController.Data.ApplicationDbContext context)
        {
            _context = context;
        }
        [BindProperty]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("./Pruebas/IndexPrueba");
        }
